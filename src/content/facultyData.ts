...
export const FACULTY_MEMBERS: FacultyMember[] = [
  ...
  },
  {
    ...
    title: 'Nguyên Head of Marketing Golden Gate Group · Chuyên Gia Tiếp Thị Bán Lẻ & Chuỗi F&B',
    ...
    keyHighlights: [
      ...
      'Chuyên gia ứng dụng AI trong cá nhân hóa trải nghiệm khách hàng và tự động hóa chiến dịch tiếp thị chuỗi',
    ],
    organizations: ['Golden Gate Group', 'Lotte Vietnam', 'Hải Sản Hoàng Gia Group'],
