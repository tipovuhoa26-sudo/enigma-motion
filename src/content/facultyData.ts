...
export const FACULTY_MEMBERS: FacultyMember[] = [
  ...
  },
  {
    ...
    title: 'CMO Chuỗi Chạm (Chạm Đà Lạt) · Nguyên Head of Marketing Golden Gate Group',
    ...
    keyHighlights: [
      ...
      'Hiện là Giám Đốc Tiếp Thị (CMO) Chuỗi Chạm (Chạm Đà Lạt — chamdalat.vn), thuộc HAKICO Group',
    ...
    organizations: ['Chuỗi Chạm (HAKICO Group)', 'Golden Gate Group', 'Lotte Vietnam', 'Hải Sản Hoàng Gia Group'],
