  ...
  },
  {
    ...
    evidence: [
      ...
      },
      {
        ...
        story: 'Đội ngũ marketing nội bộ 4 người trực tiếp làm chủ quy trình đóng gói tri thức (Tầng 2), biến kinh nghiệm thực chiến của các chuyên gia thành bài viết chuyên sâu chuẩn Brand Voice mà không phụ thuộc agency ngoài.',
        metrics: [
...
export const ASSESSMENT_QUESTIONS: AssessmentQuestion[] = [
  {
    ...
    subtext: 'Trục 1: Chiến lược số do bài toán kinh doanh dẫn dắt (Trụ cột 1)',
    options: [
      {
        score: 1,
      ...
      },
      {
        ...
        description: 'Đã đầu tư license cho một số nhóm (như Marketing, IT), nhưng chưa gắn với mục tiêu P&L hay bài toán kinh tế cụ thể.',
      },
      {
        score: 3,
        level: 'Cấp độ 3 · Chuẩn Hóa',
        label: 'Có lộ trình use case rõ ràng',
        description: 'Đã xác định các miền nghiệp vụ trọng điểm cần chuyển đổi, xếp hạng ưu tiên theo giá trị tài chính tạo ra cho từng phòng ban.',
      },
      {
        score: 4,
  ...
  {
    id: 'q2',
    axis: 'Dữ liệu & hệ thống công nghệ',
    pillarNumber: 4,
    question: 'Dữ liệu và hạ tầng phần mềm hiện tại đã sẵn sàng kết nối cho AI ở mức độ nào?',
    subtext: 'Trục 2: Dữ liệu sạch, kết nối API hai chiều & hạ tầng Private AI (Trụ cột 4 & 5)',
    options: [
      {
        score: 1,
        level: 'Cấp độ 1 · Khởi Phát',
        label: 'Dữ liệu phân mảnh, phần mềm tách biệt',
        description: 'Dữ liệu nằm rải rác trên file Excel cá nhân; nhân viên phải copy-paste dữ liệu qua lại giữa các phần mềm hoàn toàn bằng tay.',
      },
      {
        score: 2,
        level: 'Cấp độ 2 · Thử Nghiệm',
        label: 'Có cơ sở dữ liệu nhưng chưa làm sạch',
        description: 'Đã có phần mềm và thử nghiệm một số script API đơn lẻ, nhưng dữ liệu chưa được làm sạch nên AI trả lời thiếu chính xác.',
      },
      {
        score: 3,
        level: 'Cấp độ 3 · Chuẩn Hóa',
        label: 'Dữ liệu hợp nhất, AI kết nối hệ thống lõi',
        description: 'Có Single Source of Truth; AI kết nối trực tiếp với ERP/CRM/ATS qua API hai chiều, hạn chế tối đa thao tác thủ công.',
      },
      {
        score: 4,
        level: 'Cấp độ 4 · Tự Chủ',
        label: 'Hạ tầng Agentic Mesh & Private AI',
        description: 'Kiến trúc Vector Database và Data Pipeline cập nhật thời gian thực; triển khai mô hình Private AI đảm bảo dữ liệu không bị rò rỉ.',
      },
    ],
  },
  {
    ...
    subtext: 'Trục 3: Agile Operating Model & luồng phối hợp Human-in-the-loop (Trụ cột 3)',
    options: [
      {
        score: 1,
        level: 'Cấp độ 1 · Khởi Phát',
      ...
      },
      {
        ...
        description: 'Đã loại bỏ các bước lặp lại; phân định rõ ràng điểm nào AI xử lý tự động, điểm nào con người ký duyệt (Human-in-the-loop).',
      },
      {
        score: 4,
        level: 'Cấp độ 4 · Tự Chủ',
  ...
  },
  {
    ...
    subtext: 'Trục 4: Thang năng lực 5 tầng & văn hóa học tập liên tục (Trụ cột 2)',
    options: [
      {
        score: 1,
        level: 'Cấp độ 1 · Khởi Phát',
      ...
      },
      {
        ...
        description: 'Nhân viên nắm vững kỹ thuật prompt nghiệp vụ (Tầng 1 & 2); có đội ngũ AI Champions đóng vai trò dẫn dắt tại các phòng ban.',
      },
      {
        score: 4,
        level: 'Cấp độ 4 · Tự Chủ',
        label: 'Đội ngũ có khả năng tự chủ vận hành Agent',
        description: 'Nhân sự các phòng ban tự động hóa quy trình nội bộ, phối hợp nhịp nhàng với đội kỹ thuật để liên tục tối ưu giải pháp.',
      },
    ],
  },
  {
    id: 'q5',
    axis: 'Bảo mật, rủi ro & governance',
    pillarNumber: 6,
    question: 'Doanh nghiệp đang kiểm soát rủi ro bảo mật dữ liệu và pháp lý khi dùng AI như thế nào?',
    subtext: 'Trục 5: Bảo vệ bí mật kinh doanh, cam kết NDA & Enterprise Governance (Trụ cột 6)',
    options: [
      {
        score: 1,
        level: 'Cấp độ 1 · Khởi Phát',
        label: 'Chưa có quy định bảo mật khi dùng AI',
      ...
      },
      {
        score: 2,
        level: 'Cấp độ 2 · Thử Nghiệm',
        label: 'Có cảnh báo nhưng chưa có chính sách kỹ thuật',
        description: 'Đã ban hành quy định cấm chia sẻ dữ liệu nhạy cảm, nhưng chưa có rào chắn kiểm soát kỹ thuật hay giải pháp bảo vệ luồng dữ liệu.',
      },
      {
        score: 3,
        level: 'Cấp độ 3 · Chuẩn Hóa',
        label: 'Chính sách bảo mật & Gateway kiểm soát',
        description: 'Ban hành quy chế dữ liệu rõ ràng, cam kết NDA nghiêm ngặt và triển khai Enterprise Gateway bảo vệ luồng thông tin ra vào.',
      },
      {
        score: 4,
        level: 'Cấp độ 4 · Tự Chủ',
        label: 'Quản trị toàn diện với Private AI',
        description: 'Hạ tầng Private Model an toàn tuyệt đối, dữ liệu không bao giờ rời khỏi hệ thống; có hội đồng quản trị AI định kỳ kiểm toán rủi ro.',
      },
    ],
  },
  {
    id: 'q6',
    axis: 'Quản trị thay đổi & mở rộng sáng kiến',
    pillarNumber: 6,
    question: 'Doanh nghiệp có cơ chế nào để đo lường ROI và nhân rộng thành công sang các phòng ban khác?',
    subtext: 'Trục 6: Quản trị thay đổi (Change Management), đo lường P&L và nhân rộng (Trụ cột 6)',
    options: [
      {
        score: 1,
        level: 'Cấp độ 1 · Khởi Phát',
        label: 'Chưa đo lường, không có cơ chế nhân rộng',
        description: 'Các thử nghiệm dừng lại ở cấp cá nhân hoặc dự án thí điểm đơn lẻ, không ai theo dõi chỉ số ROI thực tế hay kế hoạch mở rộng.',
      },
      {
        score: 2,
        level: 'Cấp độ 2 · Thử Nghiệm',
        label: 'Có use case thành công nhưng thiếu quy trình nhân bản',
        description: 'Một bộ phận làm AI rất tốt nhưng kết quả không được đóng gói để chuyển giao sang các phòng ban khác trong doanh nghiệp.',
      },
      {
        score: 3,
        level: 'Cấp độ 3 · Chuẩn Hóa',
        label: 'Theo dõi ROI định lượng và có quy trình nhân rộng',
        description: 'Có dashboard theo dõi giờ công và chi phí tiết kiệm; có quy trình chia sẻ kinh nghiệm và chuyển giao use case giữa các phòng ban.',
      },
      {
        score: 4,
        level: 'Cấp độ 4 · Tự Chủ',
        label: 'Văn hóa đổi mới liên tục & mở rộng hệ sinh thái',
        description: 'Có cơ chế khen thưởng sáng kiến ứng dụng AI định kỳ, hỗ trợ đào tạo nhân sự mới liên tục để nhân rộng thành công toàn diện.',
      },
    ],
  },
];
