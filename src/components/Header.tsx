        ...
        <div className="max-w-[1280px] w-full mx-auto px-6 md:px-12 flex items-center justify-between">
          ...
          <Link href="/" className="flex items-center gap-3 group" aria-label="Sunext — Trang chủ">
            <div className="w-8.5 h-8.5 rounded-lg bg-[#FAF8FC] border border-[#E7E7E5] flex items-center justify-center transition-transform group-hover:scale-105 group-hover:border-[#581C87]/40">
              <svg viewBox="0 0 24 24" fill="none" className="w-4.5 h-4.5 text-[#581C87]" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
                <path d="M16.5 3.5L7.5 7.5V16.5L16.5 20.5" />
                <path d="M7.5 7.5L16.5 11.5V20.5" />
              </svg>
            </div>
            <span className="font-bold text-xl tracking-tight text-[#0A0A0A]">Sunext</span>
          </Link>

          {/* Desktop Navigation: Compact & Focused */}
          ...
          {/* Right CTAs with Crisp Orange Action Button */}
          <div className="flex items-center gap-2 sm:gap-3">
            <Link href="/#contact" className="hidden sm:inline-flex">
              <Button variant="orange" size="md" className="rounded-lg font-medium shadow-xs text-xs px-4 py-2">
            ...
            <button
              ...
              className="md:hidden w-9 h-9 rounded-lg flex items-center justify-center text-[#0A0A0A] hover:bg-black/5 transition-colors border border-[#E7E7E5]"
            >
